...
class __TwigTemplate_27ea8ca427edde7ed53d935a04e5905429e3360a0475791cc0715b3cd962ac10 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        echo "
         ...
         <div class=\"col-xl-6\">
             <div class=\"form-group\">
                 ";
        // line 29
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formMuseum"]) || array_key_exists("formMuseum", $context) ? $context["formMuseum"] : (function () { throw new RuntimeError('Variable "formMuseum" does not exist.', 29, $this->source); })()), "PersonnagePhare", [], "any", false, false, false, 29), 'row', ["label" => "Les personages du Musée : ", "attr" => ["placeholder" => "Le ou less personages importants du Musée"]]);
        echo "
             </div>
             <div class=\"form-group\">
                 ";
        // line 32
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formMuseum"]) || array_key_exists("formMuseum", $context) ? $context["formMuseum"] : (function () { throw new RuntimeError('Variable "formMuseum" does not exist.', 32, $this->source); })()), "Protectionbatiment", [], "any", false, false, false, 32), 'row', ["label" => "Spécificité du bâtiment : ", "attr" => ["placeholder" => "Spécificité du bâtiment"]]);
        echo "
             </div>
             <div class=\"form-group\">
                 ";
        // line 35
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formMuseum"]) || array_key_exists("formMuseum", $context) ? $context["formMuseum"] : (function () { throw new RuntimeError('Variable "formMuseum" does not exist.', 35, $this->source); })()), "ProtectionEspace", [], "any", false, false, false, 35), 'row', ["label" => "Spécificité du site : ", "attr" => ["placeholder" => "Spécificité du site"]]);
        echo "
             </div>
         </div>
     </div>
     ...
     <div class=\"row\">
        ...
        echo "
             ...
             <div class=\"form-group\">
                 ";
        // line 57
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formMuseum"]) || array_key_exists("formMuseum", $context) ? $context["formMuseum"] : (function () { throw new RuntimeError('Variable "formMuseum" does not exist.', 57, $this->source); })()), "CodePostal", [], "any", false, false, false, 57), 'row', ["label" => "Code Postal du Musée : ", "attr" => ["placeholder" => "Code Postal du Musée"], "required" => "required"]);
        echo "
             </div>
         </div>
         <div class=\"col-xl-6\">
 ...
 <div class=\"container\">
    ...
    {% endif  %}
     ...
     <div class=\"row\">
         <div class=\"col-xl-6\">
             <div class=\"form-group\">
                 {{ form_row(formMuseum.NomOfficiel, {'label': \"Nom du musée : \", 'attr': {'placeholder': \"Nom du musée\"}, 'required': 'required'})}}
             </div>
             <div class=\"form-group\">
         ...
         <div class=\"col-xl-6\">
             <div class=\"form-group\">
                 {{ form_row(formMuseum.PersonnagePhare, {'label': \"Les personages du Musée : \", 'attr': {'placeholder': \"Le ou less personages importants du Musée\"}})}}
             </div>
             <div class=\"form-group\">
                 {{ form_row(formMuseum.Protectionbatiment, {'label': \"Spécificité du bâtiment : \", 'attr': {'placeholder': \"Spécificité du bâtiment\"}})}}
             </div>
             <div class=\"form-group\">
                 {{ form_row(formMuseum.ProtectionEspace, {'label': \"Spécificité du site : \", 'attr': {'placeholder': \"Spécificité du site\"}})}}
             </div>
         </div>
     </div>
     ...
     <div class=\"row\">
         <div class=\"col-xl-6\">
             ...
             <div class=\"form-group\">
                 {{ form_row(formMuseum.CodePostal, {'label': \"Code Postal du Musée : \", 'attr': {'placeholder': \"Code Postal du Musée\"}, 'required': 'required' })}}
             </div>
         </div>
         <div class=\"col-xl-6\">
             <div class=\"form-group\">
                 {{ form_row(formMuseum.Telephone, {'label': \"Téléphone du Musée: \", 'attr': {'placeholder': \"Téléphone du Musée\"}, 'required': 'required' })}}
             </div>
             <div class=\"form-group\">
