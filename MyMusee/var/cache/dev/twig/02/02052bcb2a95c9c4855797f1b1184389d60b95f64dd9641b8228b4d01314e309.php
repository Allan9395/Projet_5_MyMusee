...
/* region/Provence_Alpes_Côte_d'Azur.html.twig */
class __TwigTemplate_61eca3ed37f792c2d77fdac0024cd5a14ca5c1538be05325638b060abb2a61b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "region/Provence_Alpes_Côte_d'Azur.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "region/Provence_Alpes_Côte_d'Azur.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "region/Provence_Alpes_Côte_d'Azur.html.twig", 1);
    ...
    <h1>Les Musées de la région Provence-Alpes-Côte d'Azur</h1>
    <p><a href=\"";
        // line 8
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("home");
        echo "\">Musées de France</a>/ Musées en Provence-Alpes-Côte d'Azur</p>
</div>
...
<header class=\"container\">
    <div class=\"row\">
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                <div class=\"card-header\">
                    <h5 class=\"card-title info\"> Les musées dans les Alpes-de-Haute-Provence</h5>
                </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["museum"]) {
            if ((twig_get_attribute($this->env, $this->source, $context["museum"], "Departement", [], "any", false, false, false, 19) == "Alpes-de-Haute-Provence")) {
                // line 20
                echo "                    <p><a href=\"";
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                <div class=\"card-header\">
                    <h5 class=\"card-title info\"> Les musées dans les Hautes-Alpes </h5>
                </div>
                <div class=\"card-body text-success\">
                    ";
        // line 32
        ...
        $context['_seq'] = twig_ensure_traversable($context["museum"]);
        foreach ($context['_seq'] as $context["_key"] => $context["museum"]) {
            if ((twig_get_attribute($this->env, $this->source, $context["museum"], "Departement", [], "any", false, false, false, 32) == "Hautes-Alpes")) {
                // line 33
                echo "                    <p><a href=\"";
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                <div class=\"card-header\">
                    <h5 class=\"card-title info\"> Les musées dans les Alpes-Maritimes</h5>
                </div>
                <div class=\"card-body text-success\">
                    ";
        // line 45
        ...
        $context['_seq'] = twig_ensure_traversable($context["museum"]);
        foreach ($context['_seq'] as $context["_key"] => $context["museum"]) {
            if ((twig_get_attribute($this->env, $this->source, $context["museum"], "Departement", [], "any", false, false, false, 45) == "Alpes-Maritimes")) {
                // line 46
                echo "                    <p><a href=\"";
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                <div class=\"card-header\">
                    <h5 class=\"card-title info\"> Les musées dans les Bouches-du-Rhône</h5>
                </div>
                <div class=\"card-body text-success\">
                    ";
        // line 58
        ...
        $context['_seq'] = twig_ensure_traversable($context["museum"]);
        foreach ($context['_seq'] as $context["_key"] => $context["museum"]) {
            if ((twig_get_attribute($this->env, $this->source, $context["museum"], "Departement", [], "any", false, false, false, 58) == "Bouches-du-Rhône")) {
                // line 59
                echo "                    <p><a href=\"";
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                <div class=\"card-header\">
                    <h5 class=\"card-title info\"> Les musées dans le Var</h5>
                </div>
                <div class=\"card-body text-success\">
                    ";
        // line 71
        ...
        $context['_seq'] = twig_ensure_traversable($context["museum"]);
        foreach ($context['_seq'] as $context["_key"] => $context["museum"]) {
            if ((twig_get_attribute($this->env, $this->source, $context["museum"], "Departement", [], "any", false, false, false, 71) == "Var")) {
                // line 72
                echo "                    <p><a href=\"";
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                <div class=\"card-header\">
                    <h5 class=\"card-title info\"> Les musées dans le Vaucluse</h5>
                </div>
                <div class=\"card-body text-success\">
                    ";
        // line 84
        ...
        $context['_seq'] = twig_ensure_traversable($context["museum"]);
        foreach ($context['_seq'] as $context["_key"] => $context["museum"]) {
            if ((twig_get_attribute($this->env, $this->source, $context["museum"], "Departement", [], "any", false, false, false, 84) == "Vaucluse")) {
                // line 85
                echo "                    <p><a href=\"";
...
";
    ...
    {
        return "region/Provence_Alpes_Côte_d'Azur.html.twig";
    }
    ...
    {
        return array (  287 => 88,  278 => 86,  271 => 85,  266 => 84,  255 => 75,  246 => 73,  239 => 72,  234 => 71,  223 => 62,  214 => 60,  207 => 59,  202 => 58,  191 => 49,  182 => 47,  175 => 46,  170 => 45,  159 => 36,  150 => 34,  143 => 33,  138 => 32,  127 => 23,  118 => 21,  111 => 20,  106 => 19,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"jumbotron\">
    <h1>Les Musées de la région Provence-Alpes-Côte d'Azur</h1>
    <p><a href=\"{{path('home')}}\">Musées de France</a>/ Musées en Provence-Alpes-Côte d'Azur</p>
</div>
    ...
    <div class=\"row\">
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                ...
                <div class=\"card-body text-success\">
                    {% for museum in museum if museum.Departement == 'Alpes-de-Haute-Provence' %}
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                ...
                <div class=\"card-body text-success\">
                    {% for museum in museum if museum.Departement == 'Hautes-Alpes' %}
                    <p><a href=\"{{ path('museum_show', {'id': museum.id}) }}\"> {{museum.NomOfficiel}}</a> à
                            {{museum.Ville}}</p>
                    {% endfor %}
                </div>
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                ...
                <div class=\"card-body text-success\">
                    {% for museum in museum if museum.Departement == 'Alpes-Maritimes' %}
                    <p><a href=\"{{ path('museum_show', {'id': museum.id}) }}\"> {{museum.NomOfficiel}}</a> à
                            {{museum.Ville}}</p>
                    {% endfor %}
                </div>
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                ...
                <div class=\"card-body text-success\">
                    {% for museum in museum if museum.Departement == 'Bouches-du-Rhône' %}
                    <p><a href=\"{{ path('museum_show', {'id': museum.id}) }}\"> {{museum.NomOfficiel}}</a> à
                            {{museum.Ville}}</p>
                    {% endfor %}
                </div>
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                ...
                <div class=\"card-body text-success\">
                    {% for museum in museum if museum.Departement == 'Var' %}
                    <p><a href=\"{{ path('museum_show', {'id': museum.id}) }}\"> {{museum.NomOfficiel}}</a> à
                            {{museum.Ville}}</p>
                    {% endfor %}
                </div>
        ...
        <div class=\"col-md-7\">
            <div class=\"card border-success mb-4 MuseumsRegionDepartementCard\">
                ...
                <div class=\"card-body text-success\">
                    {% for museum in museum if museum.Departement == 'Vaucluse' %}
                    <p><a href=\"{{ path('museum_show', {'id': museum.id}) }}\"> {{museum.NomOfficiel}}</a> à
                            {{museum.Ville}}</p>
                    {% endfor %}
                </div>
...
{% endblock %}", "region/Provence_Alpes_Côte_d'Azur.html.twig", "/Applications/MAMP/htdocs/OpenClassRooms/Projet_5/MyMusee/templates/region/Provence_Alpes_Côte_d'Azur.html.twig");
    }
}
