...
return [
    ...
    'museum_contact' => [[], ['_controller' => 'App\\Controller\\HomeController::contact'], [], [['text', '/contact']], [], []],
    'museum_region' => [['region'], ['_controller' => 'App\\Controller\\HomeController::regionsList'], [], [['variable', '/', '[^/]++', 'region', true], ['text', '/region']], [], []],
