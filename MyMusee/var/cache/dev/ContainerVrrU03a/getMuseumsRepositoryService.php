...
// Returns the private 'App\Repository\MuseumsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MuseumsRepository.php';

return $this->privates['App\\Repository\\MuseumsRepository'] = new \App\Repository\MuseumsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
